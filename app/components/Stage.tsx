...
export default function Stage({
  ...
  return (
    <div
      ...
      className="relative min-h-0 min-w-0 overflow-hidden rounded-2xl border border-theme-700/30 bg-theme-50 shadow-2xl shadow-theme-800/15 outline-none focus-visible:ring-2 focus-visible:ring-accent-500"
    >
